...
void main() {
  ...
  //   );
  //   final sig = await sign(hashedPayload, privKey);
  ...
  test('signatures recover the public key of the signer', () async {
    final messages = [
      'Hello world',
      'UTF8 chars ©âèíöu ∂øµ€',
      '🚀✨🌎',
    ...
    for (final message in messages) {
      ...
      for (final privateKey in privateKeys) {
        ...
        final signature = await sign(messageHash, hexToBytes(privateKey));
  ...
  test('signature validity can be properly verified', () async {
    final messages = [
      'Hello world',
      'UTF8 chars ©âèíöu ∂øµ€',
      '🚀✨🌎',
