...
import 'package:app/contracts/SimpleWallet.g.dart';
...
class Guardian {
  ...
  Guardian(this.web3, this.contract);
  ...
  Future<UserOperation> _guardian(BigInt nonce,
      EthereumAddress entryPointAddress, EthereumAddress paymasterAddress,
      BigInt maxFeePerGas, BigInt maxPriorityFeePerGas, Uint8List callData) async {
  ...
  Future<UserOperation> grantGuardianRequest(BigInt nonce, EthereumAddress guardianAddress,
      EthereumAddress entryPointAddress, EthereumAddress paymasterAddress,
      BigInt maxFeePerGas, BigInt maxPriorityFeePerGas) async {
      ...
      return _guardian(nonce, entryPointAddress, paymasterAddress, maxFeePerGas, maxPriorityFeePerGas, callData);
  }

  Future<UserOperation> revokeGuardianRequest(BigInt nonce, EthereumAddress guardianAddress,
      EthereumAddress entryPointAddress, EthereumAddress paymasterAddress,
      BigInt maxFeePerGas, BigInt maxPriorityFeePerGas) async {
  ...
  Future<UserOperation> deleteGuardianRequest(BigInt nonce, EthereumAddress guardianAddress,
      EthereumAddress entryPointAddress, EthereumAddress paymasterAddress,
      BigInt maxFeePerGas, BigInt maxPriorityFeePerGas) async {
  ...
  Future<UserOperation> revokeGuardianConfirmation(BigInt nonce, EthereumAddress guardianAddress,
      EthereumAddress entryPointAddress, EthereumAddress paymasterAddress,
      BigInt maxFeePerGas, BigInt maxPriorityFeePerGas) async {
    final grantGuardianRequest = contract.function('revokeGuardianConfirmation');
    final callData = grantGuardianRequest.encodeCall([guardianAddress]);
    return _guardian(nonce, entryPointAddress, paymasterAddress, maxFeePerGas, maxPriorityFeePerGas, callData);
  }

  Future<UserOperation> transferOwner(BigInt nonce, EthereumAddress newOwner,
      EthereumAddress entryPointAddress, EthereumAddress paymasterAddress,
      BigInt maxFeePerGas, BigInt maxPriorityFeePerGas) async {
