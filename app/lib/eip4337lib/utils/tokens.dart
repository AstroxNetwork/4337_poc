...
Future<UserOperation> createOp(
  ...
  userOperation.callData =
      execFromEntryPoint.encodeCall([callContract, value, encoded]);
...
class ETH {
  ...
  Future<UserOperation> transfer(
      ...
      EthereumAddress to,
      BigInt value) async {
    return createOp(web3, entryPointAddress, paymasterAddress, walletAddress,
        nonce, maxFeePerGas, maxPriorityFeePerGas, to, Uint8List(0), value);
  }
}
...
class ERC20 {
  ...
  Future<UserOperation> transferFrom(
      EthereumAddress walletAddress,
      BigInt nonce,
      EthereumAddress entryPointAddress,
      EthereumAddress paymasterAddress,
...
class ERC721 {
  ...
  Future<UserOperation> safeTransferFrom(
      EthereumAddress walletAddress,
      BigInt nonce,
      EthereumAddress entryPointAddress,
      EthereumAddress paymasterAddress,
  ...
  Future<UserOperation> setApprovalForAll(
      EthereumAddress walletAddress,
      BigInt nonce,
      EthereumAddress entryPointAddress,
      EthereumAddress paymasterAddress,
